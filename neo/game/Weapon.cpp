...
// OCULUS BEGIN
// Merge Lasersight from Doom3 BFG Edition
/*
================
...
bool idWeapon::GetMuzzlePositionWithHacks(idVec3 & origin, idMat3 & axis)
{
	...
	viewmodel_fists
	*/
	const char *weaponName = weaponDef->dict.GetString("model_view");

	origin = playerViewOrigin;
	axis = playerViewAxis;
	
	if (idStr::Icmp(weaponName, "viewmodel_grenade") == 0)
		return false;
	if (idStr::Icmp(weaponName, "viewmodel_chainsaw") == 0)
		return false;
	if (idStr::Icmp(weaponName, "viewmodel_soulcube") == 0)
		return false;
	if (idStr::Icmp(weaponName, "viewmodel_flashlight") == 0)
		return false;
	if (idStr::Icmp(weaponName, "viewmodel_fists") == 0)
		return false;
	...
	if (idStr::Icmp(weaponName, "viewmodel_pistol") == 0)
	{
	...
	if (idStr::Icmp(weaponName, "viewmodel_rocketlauncher") == 0)
	{
	...
	if (idStr::Icmp(weaponName, "viewmodel_shotgun") == 0)
	{
		// joint doesn't point straight, so rotate it
